...
france: marseille
marseille:
	COUNTRY_NAME='france' AREA_NAME='marseille' BBOX='426000.0,5137000.0,465000.0,5176000.0' BBOX_CRS='ESRI:54009' CENTRE='445500.0,5156500.0' \
	CENTRE_CRS='ESRI:54009' BUFFER_ESTIMATION_CRS='EPSG:2154' GTFS_OSM_SUBDIR='france/marseille' EMPTY_FEED=1 FAST_TRAVEL=0 CALCULATE_SUMMARIES=0 \
	docker compose up
